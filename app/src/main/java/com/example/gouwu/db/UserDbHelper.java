...
public class UserDbHelper extends SQLiteOpenHelper {
    ...
    public UserInfo login(String username) {
        ...
        String sql = "select user_id,username,password,nickname,pic  from user_table where username=?";
        ...
        if (cursor.moveToNext()) {
            ...
            userInfo = new UserInfo(user_id, name, password, nickname,pic);
        }
        cursor.close();
        //db.close();
        return userInfo;
    ...
    //修改头像
    public int updatePic(String username, String pic) {
        //获取SQLiteDatabase实例
        SQLiteDatabase db = getWritableDatabase();
        // 填充占位符
        ContentValues values = new ContentValues();
